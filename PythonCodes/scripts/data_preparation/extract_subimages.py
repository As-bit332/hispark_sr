...
def main():
    ...
    # HR images
    opt['input_folder'] = '../../datasets/RealSR(V3)/Nikon/Test/4/HR'
    opt['save_folder'] = '../../datasets/RealSR(V3)/Nikon/Test/4/HR_sub'
    opt['crop_size'] = 1024
    opt['step'] = 1024
    opt['thresh_size'] = 0
    ...
    # LRx2 images
    # opt['input_folder'] = '../../datasets/RealSR(V3)/Nikon/Test/4/LR'
    # opt['save_folder'] = '../../datasets/RealSR(V3)/Nikon/Test/4/LR_sub'
    # opt['crop_size'] = 256
    # opt['step'] = 256
    # opt['thresh_size'] = 0
    # extract_subimages(opt)
    ...
    for x in h_space:
        for y in w_space:
            ...
            cv2.imwrite(
                ...
                # osp.join(opt['save_folder'], f'{img_name}s{index:03d}{extension}'), cropped_img,
