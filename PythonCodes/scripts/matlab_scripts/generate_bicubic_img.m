...
input_folder = '../../datasets/RealSR(V3)/Nikon/Test/4/LR';
save_mod_folder = '../../datasets/RealSR(V3)/Canon/Test/4/GTmod12';
save_lr_folder = '../../datasets/RealSR(V3)/Canon/Test/4/LRbicx4';
save_bic_folder = '../../datasets/RealSR(V3)/Nikon/Test/4/bic';
